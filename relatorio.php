        ...
        <div class="row">
          ...
          <div class="card">
              <div class="card-header">
                <h3 style="margin-left: 37%; font-size: 30px; " class="card-title">Relatório de Contatos</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td style="vertical-align:middle;"><a href="editar.php?idUp=<?php echo $show->id_contato;?>" title="editar" class="btn btn-success"><img style="width: 15px;" src="img/svg/editar.png"></a>
                    <a href="deletar.php?idDel=<?php echo $show->id_contato;?>" onclick="return confirm('Tem certeza?')" title="remover" class="btn btn-danger"><img style="width: 15px;" src="img/svg/remover.png"></a></td>
                  </td>
                  </tr>
                  <?php
                      }
