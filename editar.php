  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Thainá M</a>
        </div>
      </div>
          ...
          <div class="col-md-5">
            <div class="card card-primary">
                 ...
                 try{
                   ...
                   if($contar>0){
                     while($show = $resultSel -> FETCH(PDO::FETCH_OBJ)){
                       ...
                       $telefone = $show->telefone_contato;
                       $email = $show->email_contato;
                       $foto = $show->foto_contato;

                     }
                   }else{
                     echo '<div class="alert alert-danger"> Contato não cadastrado!</div>';
                   }
              ...
              <form action="" method="post" enctype="multipart/form-data">
                <!--O método enctype é um método justamente para definir, no formulário, o uso de multimídia.-->
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputPassword1">Nome</label>
                    <input name="nome" type="text" class="form-control" id="exampleInputPassword1" placeholder="<?php echo $nome;?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Telefone</label>
                    <input name="telefone" type="text" class="form-control" id="exampleInputPassword1" placeholder="<?php echo $telefone;?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Endereço de E-mail</label>
                    <input name="email" type="email" class="form-control" id="exampleInputEmail1" placeholder="<?php echo $email;?>">
                  </div>
                ...
                <div class="card-footer">
                  <button name="btnCadContato" type="submit" class="btn btn-primary">Editar Contato</button>
                </div>
              </form>
              <?php
                  include_once('config/conexao.php');
                  if(isset($_POST['btnCadContato'])){
                      ...
                      /* 
                      A var '$formatP' foi usada para definir quais exensões serão aceitas
                         PATHNFO_EXTENSION faz a extração a extensão do nome do arquivo
                         O print_r() exibe arquivos de multimídia
                         A leitura de imagens deve ser por uma array
                         $foto = $_POST['foto']; 
                         O método uniqid() codifica o nome do arquivo
                      */
          ...
          <div class="col-md-7">
            <div class="card card-primary">
              ...
              <div class="card-body p-0" style="text-align:center;">
                <img style="width: 150px; border-radius: 100px; margin-top: 100px;" src="img/contato/622b2aa3cd7ba.jpg">
                <h1>Maria</h1>
                <h2>8957904358</h2>
                <h4 style="margin-bottom: 110px;">maria@gmail.com</h4>
              </div>
              <!-- /.card-body -->
            </div>
          </div>
